// Botón flotante de WhatsApp — fijo en el extremo inferior derecho (global).
const PHONE = "5491148495688";
const MSG = "Hola! Quiero hacer una consulta sobre un evento.";
...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed z-[70] flex items-center justify-center rounded-full shadow-lg hover:scale-110 transition-transform"
      style={{
        right: 20,
        bottom: 68, // por encima de la barra de preview inferior
        width: 56,
        height: 56,
